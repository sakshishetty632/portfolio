            ...
            <div className="mx-auto flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="md:w-2/3 2xl:w-1/2 w-full px-4 ">
                    ...
                    <div className="flex justify-center sm:justify-start space-x-6 mb-13">
                        ...
                        <a href="https://drive.google.com/file/d/1nt__p0UgVGaPkCTZY-bxOAXsJNvjygN3/view?usp=sharing" className="bg-slate-100 hover:bg-slate-200 transform transition-all p-2 rounded" target="_blank" rel="noopener noreferrer">
