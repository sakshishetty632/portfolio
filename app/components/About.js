        ...
        <section  id="about" className="text-teal-700 flex flex-col mt-12 items-center justify-center">
            ...
            <div className="mx-auto  flex flex-col md:flex-row items-center justify-center " >
                ...
                <div className="md:w-2/3 w-full px-4 ">
                    ...
                    <p className="text-lg mb-14 text-teal-900">
                        Hi, I’m <strong>Sakshi Shetty.</strong> I enjoy building thoughtful software and exploring how things work—from backend logic to frontend flow.
                        I work with <strong>Java, Spring Boot, Angular, C++, and C</strong>, and I'm always looking for ways to grow and improve.
                    ...
                    <div className="flex justify-center space-x-6 mb-5">
                        <a href="https://www.linkedin.com/in/shetty-sakshi" target="_blank" rel="noopener noreferrer">
                            <FaLinkedin className="text-4xl hover:text-teal-900 transition duration-300" />
                        </a>
                        <a href="https://github.com/sakshishetty632" target="_blank" rel="noopener noreferrer">
                            <FaGithub className="text-4xl hover:text-teal-900 transition duration-300" />
                        </a>
                        <a href="/SakshiShettyResume.pdf" target="_blank" rel="noopener noreferrer">
                            <FaFileAlt className="text-4xl hover:text-teal-900 transition duration-300" />
                        </a>
