            ...
            <div className="container flex md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow md:w-2/3 2xl:w-1/2 md:pr-16 flex flex-col md:items-center md:text-left sm:mb-16 sm:ml-15 md:mb-0 items-center text-center">
                    <div className="flex gap-1 items-start">
                        ...
                        <h3 className="sm:text-3xl text-2xl 2xl:text-4xl mb-8 font-medium text-slate-900">Hi, I'm</h3>
                    </div>
                    <h1 className={`sm:text-7xl text-3xl 2xl:text-8xl mb-2 font-medium text-teal-900 ${myFont.className}`}>
                        Sakshi Shetty
                    </h1>
                    ...
                    <div className="flex items-baseline sm:w-110 gap-2 mt-3">
                        ...
                        <div className="text-teal-700 text-base md:text-2xl 2xl:text-3xl font-semibold min-w-[14rem] sm:min-w-[18rem] 2xl:min-w-[24rem] h-[2.5rem] flex items-start">
                            <Typewriter
                                options={{
