...
export const Hero = () => {
    return (
        <section id="home" className="text-slate-600">
            <div className="container flex md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow  md:w-2/3  md:pr-16 flex flex-col md:items-center md:text-left mb-16 ml-15 md:mb-0 items-center text-center">
                    <div className="flex gap-1 items-start">
                        ...
                        <h3 className="sm:text-3xl text-xl mb-8 font-medium text-slate-900">Hi, I'm</h3>
                    </div>
                    ...
                    <div className="flex items-baseline w-110 gap-2 mt-3 ">
                        <h2 className="text-lg md:text-2xl text-slate-900 font-medium whitespace-nowrap">
                            I am into
                        </h2>
